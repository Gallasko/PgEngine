...
void test_inclusive_scan(unsigned) {
...
template <typename T, typename B>
void test_initialized_inclusive_scan(unsigned) {
...
template <typename T, typename B>
void test_exclusive_scan(unsigned) {
...
template <typename T, typename B>
void test_transform_inclusive_scan(unsigned) {
...
template <typename T, typename B>
void test_initialized_transform_inclusive_scan(unsigned) {
...
template <typename T, typename B>
void test_transform_exclusive_scan(unsigned) {
