Here's an example of reStructuredText (reST) documentation for the **PositionComponent** and its system, along with a basic example, for your Read the Docs wiki.
