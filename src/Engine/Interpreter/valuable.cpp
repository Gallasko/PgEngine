 ...
 */
std::shared_ptr<Valuable> Function::getValue(std::queue<std::shared_ptr<Valuable>>& args) const
{
 ...
 */
std::shared_ptr<Valuable> Function::call(std::queue<std::shared_ptr<Valuable>>& args) const
{
    int i = 0;
...
std::shared_ptr<Valuable> Class::getValue(std::queue<std::shared_ptr<Valuable>>& args) const
{
...
std::shared_ptr<Valuable> ClassInstance::getValue(std::queue<std::shared_ptr<Valuable>>&) const
{
    return std::make_shared<Variable>(name);
}
...
AtFunction::AtFunction(ExprPtr self, std::shared_ptr<Environment> env, const std::string& name, const Token& token, VisitorInterpreter* visitor, std::queue<ExprPtr> argsList, StatementPtr body) :
...
ValuablePtr AtFunction::call(ValuableQueue& args) const
{
